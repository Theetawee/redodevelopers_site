...
from .views import index,services,policy,sitemap,robots,contact,company,solutions,newsletter,twitter,facebook,linkedin,iot,get_meeting,newsletter_page
...
urlpatterns=[
    ...
    path('newsletter/page/',newsletter_page,name='sendnews')
]